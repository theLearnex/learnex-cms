...
<title>welcome - <?php print($userRow['staff_email']); ?></title>
</head>
...
<nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
			  ...
			  <span class="glyphicon glyphicon-user"></span>&nbsp;Hi' <?php echo $userRow['staff_email']; ?>&nbsp;<span class="caret"></span></a>
    ...
    <div class="container">
    	...
    	<label class="h5">welcome : <?php print($userRow['staff_name']); ?></label>
        <hr />
