...
if(isset($_POST['btn-signup']))
{
 ...
 $password = $_POST['password'];
   ...
   else
   {
      try
      {
         $stmt = $DB_con->prepare("SELECT first_name,email_id FROM tbl_users WHERE first_name=:first_name OR email_id=:email_id");
         ...
         {
            if($user->register($first_name,$email_id,$password)) 
            {
...
<head>
  ...
  <title>LearnEX | Registration Page</title>
