<?php
include_once($_SERVER['DOCUMENT_ROOT'] . "/learn/dbconfig.php");
...
class crud
{
	...
	public function create($fname,$lname,$email,$mobile,$password,$gender,$dob,$zipcode, $about_me,$basic_information,$work_education,$slogan,$zone,$state,$city)
	{
		try
		{
			$stmt = $this->conn->prepare("INSERT INTO tbl_users(first_name,last_name,email_id,mobile,password,gender,dob,zipcode,about_me,basic_information,work_education,slogan,zone_id,state_id,city_id) VALUES(:fname, :lname, :email, :mobile, :password, :gender, :dob, :zipcode, :about_me, :basic_information, :work_education, :slogan, :zone_id, :state_id, :city_id)");
	...
	public function dataview($query)
	{
		...
		if($stmt->rowCount()>0)
		{
			while($row=$stmt->fetch(PDO::FETCH_ASSOC))
			{
                ...
                <td align="center">
                <a href="user-management/edit-data.php?edit_id=<?php print($row['id']); ?>"><i class="glyphicon glyphicon-edit"></i></a>
                </td>
                <td align="center">
                <a href="user-management/delete.php?delete_id=<?php print($row['id']); ?>"><i class="glyphicon glyphicon-remove-circle"></i></a>
                </td>
                </tr>
                <?php
			}
