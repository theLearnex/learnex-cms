...
{   $id = $_GET['edit_id'];
    ...
    if($crud->update($id,$fname,$lname,$email,$mobile,$password,$gender,$dob,$zipcode, $about_me,$basic_information,$work_education,$slogan,$zone,$state,$city))
    {
        ...
        <strong>WOW!</strong> Record was updated successfully <a href='../user-management.php'>HOME</a>!
        </div>";
    }
    else
    {
                    ...
                    <div class="box box-warning">
                      ...
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" textarea class="form-control" value="<?php echo $about_me; ?>" rows="2" placeholder="About Me" name="about_me">
                          </textarea>
                        </div>

                        <div class="form-group">
                          <label>Basic Information</label>
                          <input type="text" textarea class="form-control" value="<?php echo $basic_information; ?>" rows="2" placeholder="Basic Information" name="basic_information">
                          </textarea>
                        </div>

                        <div class="form-group">
                          <label>Work Education</label>
                          <input type="text" textarea class="form-control" value="<?php echo $work_education; ?>" rows="2" placeholder="Work Education" name="work_education">
                          </textarea>
                        </div>

                        <div class="form-group">
                          <label>Slogan</label>
                          <input type="text" textarea class="form-control" value="<?php echo $slogan; ?>" rows="2" placeholder="Slogan" name="slogan">
                          </textarea>
                        </div>
                        <!-- /.box-body -->
                        <div class="row">
