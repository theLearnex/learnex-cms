...
if(isset($_POST['btn-update']))
{
    ...
    if($crud->update($id,$fname,$lname,$email,$mobile,$password,$gender,$dob,$zipcode,$about_me,$basic_information,$work_education,$slogan,$zone,$state,$city,$photo))
     {
                            ...
                            <form method="post" id="demo_form" data-parsley-validate="">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" value="<?php echo $email_id; ?>" name="email_id" data-parsley-trigger="change" required=""
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" textarea class="form-control" value="<?php echo $basic_information; ?>" rows="2" placeholder="Basic Information"
                                    name="basic_information"></textarea>
                            </div>

                            <div class="form-group">
                                <label>Work Education</label>
                                <input type="text" textarea class="form-control" value="<?php echo $work_education; ?>" rows="2" placeholder="Work Education"
                                    name="work_education"></textarea>
                            </div>
